# =============================================================================
# SAF LSTM – TimeSeriesSplit (GENEL CV + DOĞRU FINAL TEST)
# =============================================================================
...
DATA_PATH = r"C:\Users\meric\Desktop\kodlama\python\yapay_sinir_proje\NVDA.csv"
...
for fold, (train_idx, val_idx) in enumerate(tscv.split(df_trainval), 1):
    ...
    train_ds = LSTMDataset(df_trainval.iloc[train_idx], WINDOW_SIZE)
    val_ds   = LSTMDataset(df_trainval.iloc[val_idx], WINDOW_SIZE)
...
# GENEL CV SONUÇLARI
# =============================================================================
print("\n===== GENEL CROSS-VALIDATION SONUÇLARI =====")
...
# =============================================================================
# FINAL MODEL – TÜM TRAIN+VAL
# =============================================================================
print("\n===== FINAL MODEL EĞİTİMİ =====")

final_train_loader = DataLoader(
    LSTMDataset(df_trainval, WINDOW_SIZE),
    batch_size=BATCH_SIZE,
    shuffle=False
)

final_model = LSTM_Model().to(device)
...
for epoch in range(EPOCHS):
    ...
    print(f"Epoch {epoch+1:03d} | Train Loss: {loss_sum/len(final_train_loader):.6f}")

# =============================================================================
# FINAL TEST
# =============================================================================
test_loader = DataLoader(
    LSTMDataset(df_test, WINDOW_SIZE),
    batch_size=BATCH_SIZE,
    shuffle=False
)
...
final_mse  = mean_squared_error(true_prices, pred_prices)
final_rmse = np.sqrt(final_mse)
final_mae  = mean_absolute_error(true_prices, pred_prices)
final_mape = np.mean(np.abs((true_prices - pred_prices) / true_prices)) * 100
final_r2   = r2_score(true_prices, pred_prices)
